/**
 * @author Luisa Nogueira Campos Silva Souza
 * 19/04/2022
 */
...
class Lista{
    private Filme[] array;
    private int n; //quantidade de strings dentro do array
    ...
    /**
     * Insere uma string na ultima posição da lista
     * @param x String  a ser inserido
    ...
    public void inserirFim(Filme x)throws Exception{
        ...
        array[n] = x; //o array recebe a string na ultima posição
        n++;
    }
...
public class PesquisaBinaria{
    ...
    */
    ...
    public static void main(String[] args)throws Exception{
        ...
        long start = System.currentTimeMillis(); // começa a calcular o tempo de execuçao 
        String line = MyIO.readLine();
        ...
        for(int i = 0; i < count; i++){
            if(lista.pesqBin(entrada[i]) == true){
        ...
        long end = System.currentTimeMillis() - start; //termina o calculo e extrai o inicio para saber o exato tempo de execucao
        //fazer arquivo log 
        FileWriter arq = new FileWriter("matricula_binaria.txt");
        PrintWriter gravarArq = new PrintWriter(arq);
        
        gravarArq.println("747560\t" + end + "ms\t");
